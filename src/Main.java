...
public class Main {
  ...
  // of the array
    //time complexity is: n^2, where there is a for-each in computeFactorial, and computeFactorial is wrapped in a for-each
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
    //time complexity is n^2, where n*n is wordsA * wordsB
  // YOUR ANSWER HERE
  ...
  // The time complexity is:
  // o(1) / 1, where 1 is the return of a + b / 2
  // YOUR ANSWER HERE
  ...
  // YOUR ANSWER HERE
    //time complexity is O(n), where for each for wordList is O(n), and wordSet.contains() is O(1) complexity
  ...
  // Hashmap for storing varied data effectively
  // Updated here
  ...
  // What would be a good choice of data structure?
  // YOUR ANSWER HERE: An ArrayList should suffice as an appropriate data structure
  ...
  // What would be a good choice of data structure?
  // YOUR ANSWER HERE
  // ArrayList, best for short simple data structures
}